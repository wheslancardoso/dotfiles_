local set = vim.opt
set.cursorcolumn = false -- This sets the 'cursorcolumn' option to true, which enables highlighting of the current cursor column.
set.relativenumber = true -- This sets the 'relativenumber' option to true, which displays line numbers relative to the current line.
set.showcmd = true -- This sets the 'showcmd' option to true, which displays incomplete commands on the last line of the screen.
vim.g["VM_mouse_mappings"] = 1 -- This enables mouse support for the Visual Multi plugin.
set.shell = "/bin/zsh" -- sets the shell for the terminal emulator to Zsh.
set.linebreak = true -- enables line wrapping at specified characters instead of breaking words in text with spaces.
set.wrap = true -- disables automatic line wrapping
set.sessionoptions = "blank,buffers,curdir,folds,help,tabpages,winsize,winpos,terminal,localoptions" -- configures what should be saved in the session file when the editor is closed.
